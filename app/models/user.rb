class User
  ...
  attr_accessible :email, :password, :password_confirmation, :remember_me,:zipcode,:city,:location,:phone_no,:vegetarian,:choose_one,:sex,:business_location_shop,:average_per_month,:photo,
                  ...
                  :dl_onpremises ,:bdeliver_customer,:business_location,:plan_id,:role_id,:coordinates,:vegan,:user_name,:business_with_BBB
  ...
  field :business_with_BBB,          :type => String, :default => ""
  ## Recoverable
